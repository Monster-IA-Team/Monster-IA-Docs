...
\begin{itemize}
    ...
    \item Stworzenie systemu logowania, rejstracji, odzyskiwania hasła i endpointów CRUD
\end{itemize} 
\textbf{Plusy projektu:} Zdobycie praktycznej wiedzy o Transfer Learningu; integracja modeli z API.\\
\textbf{Minusy/Trudności:} (np. Problemy z doborem odpowiednich parametrów optymalizatora).
...
\textbf{Zakres prac:} Frontend w React, budowa UI i UX, podłączenie API \\
\textbf{Plusy projektu:} Usprawnienie tworzenia komponentów w Tailwind CSS; nowoczesny routing.\\
\textbf{Minusy/Trudności:} 
